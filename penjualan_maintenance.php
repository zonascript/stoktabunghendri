  ...
  <div class="text-center">
	...
	<div id="po" style="width:640px;">
		<div class="container" style="width: 100%; border:2px solid #000;">
			<div class="title" style="text-align: left; margin-left: 30px; margin-top:3%;">Purchasing Order Tanggal : <input type="text" name="tanggal" /> (Contoh : 2016-08-17)</div>
			<div class="title" style="text-align: left; margin-left: 30px;">Nomor Faktur: <input type="text" name="po_fak"/> (Contoh : FAK/2015/09/0003)</div>
